...
public class Assets {
    ...
    public static BufferedImage grass, dirt, water, sand, wall, hole, lava, ice, golfBall, bowlingBall, arrow;
    ...
    public static void init() {
        ...
        bowlingBall = spriteSheet.crop(width * 6, height, width * 2, height * 2);

        //row 3
        arrow = spriteSheet.crop(0, height * 2, width * 2, height);
    }
